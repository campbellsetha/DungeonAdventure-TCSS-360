...
{
	private static RoomTypeCollection _myRoomTypes = new RoomTypeCollection();
	private static Dictionary<RoomTypeCollection.RoomType, PackedScene> _myRoomTypeDict = _myRoomTypes.RoomDictionary;
	...
	public void BuildDungeon()
	{
		for (int i = 0; i < _myDungeonLength; i++)
		{
			for (int j = 0; j < _myDungeonWidth; j++)
			{
				...
				//switch statement
				PackedScene roomToLoad = _myRoomTypeDict[RoomTypeCollection.RoomType.FourDoor];
				//Instantiate
